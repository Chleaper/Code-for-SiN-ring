...
model.component('comp1').view('view1').axis.set('xmin', 228.29173278808594);
model.component('comp1').view('view1').axis.set('xmax', 260.3082580566406);
model.component('comp1').view('view1').axis.set('ymin', -9.975000381469727);
model.component('comp1').view('view1').axis.set('ymax', 9.975000381469727);
...
model.study('std3').feature('mode').set('neigs', 10);
...
model.sol('sol1').feature('e1').set('neigs', find_mode_number);
...
model.result('pg1').label([native2unicode(hex2dec({'75' '35'}), 'unicode')  native2unicode(hex2dec({'57' '3a'}), 'unicode') ' (ewfd)']);
...
model.result('pg1').set('looplevel', plot_number);
mphplot(model,'pg1');
title(['effective index=',num2str(neff(plot_number))]);
neff=mphglobal(model,'ewfd.neff');